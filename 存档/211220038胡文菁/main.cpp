...
int admin_mod(){ //0正常退出，1登录失败
  ...
  while(log_res){
    ...
    switch (opt) {
      ...
      default: {
        cout << "\033[01;31m请输入1-7之间的整数！\033[0m" << endl;
        break;
      }
    }
  }
...
int cart_mod(Buyer &buyer, User &user){
  ...
  while(true){
    ...
    switch (opt) {
      ...
      default:{
        cout << "\033[01;31m请输入1-5之间的整数！\033[0m" << endl;
        break;
      }
    }
  }
...
int buyer_mod(Buyer &buyer, User &user){
  ...
  while(true){
    ...
    switch (opt) {
      ...
      default: {
        cout << "\033[01;31m请输入1-6之间的整数！\033[0m" << endl;
        break;
      }
    }
  }
...
int main()
{
  init();
  read();
  ifstream ifs("/Users/huwenjing/project01/title.txt");
  string tmp;
  while(getline(ifs, tmp)){
    cout << "\033[01;34m" << tmp << endl;
  }
  cout << "\033[0m";
  int opt=0;
  while (true)
