...
void Seller::sell_good(User &user) {
  ...
  if(!res){
    ...
    cout << "\033[01;33m请确认发布的商品信息无误！\033[0m" << endl;
    cout << "***************************************" << endl;
    ...
    cout << "***************************************" << endl;
    cout << endl;
    cout << "\033[01;33m你确认要发布商品吗？(y/n)\033[0m";
    ...
    //选择是否生成指令
    if(opt == 'n'){
      cout << "\033[01;33m取消商品发布！\033[0m" << endl;
    }
    else{
      cout << "\033[01;32m发布商品成功！\033[0m" << endl;
      string manipulator = "seller";
      ...
      switch (attribute[0]) {
        case '1':{
          ...
          if(!res){
            ...
            cout << "\033[01;33m请确认修改的信息无误！\033[0m" << endl;
            cout << "*************************" << endl;
            ...
            cout << "*************************" << endl;
            cout << "\033[01;33m确认修改？(y/n)\033[0m";
            ...
            if(opt == 'n'){
              cout << "\033[01;33m取消修改\033[0m" << endl;
            }
            else {
        ...
        case '2':{
          ...
          if(opt == 'n'){
            cout << "\033[01;33取消修改\033[0m" << endl;
          }
          else {
            cout << "\033[01;32m修改成功\033[0m" << endl;
            string manipulator = "seller";
