...
void User::user_manu() {
  cout << "\033[34m===========================================================" << endl;
  cout << "1.我是买家 2.我是卖家 3.个人信息管理 4.留言系统 5.注销登录" << endl;
  cout << "===========================================================" << endl;
  cout << endl;
  cout << "请输入操作：\033[0m";
}
...
void User::change(User &user) {
  ...
  switch (opt) {
    case 1:{
      ...
      if(res){
        user.name = new_name;
        cout << "\033[01;32m修改成功！\033[0m" << endl;
      }
      else{
        cout << "\033[01;31m存在重名,修改失败！\033[0m" << endl;
      }
      break;
    }
    case 2:{
    ...
    default:{
      cout << "\033[01;31m请输入1-4之间的整数！\033[0m" << endl;
      break;
    }
  }
...
void User::recharge(User &user) {
  ...
  for(int i = 0; i < len; i++){
    if(this_money[i] != '.' && !(this_money[i] >= '0' && this_money[i] <= '9')){
      cout << "\033[01;31m输入不合法！\033[0m" << endl;
      return ;
    }
  }
  if(this_money.find('.') != string::npos){
    ...
    if(len-p >= 3){
      cout << "\033[01;31m充值失败！最多只能输入一位小数！\033[0m" << endl;
      return ;
    }
  }
  else{
  ...
  cout << "\033[01;32m充值成功，当前余额：\033[0m" << user.money << endl;
  cout << endl;
}
...
bool User::log_in(User &user) {
  ...
  if(res&&alive) {
    ...
    cout << endl;
    cout << "\033[01;31m-----您已被封禁-----\033[0m" << endl;
    cout << endl;
  }
  else{
    cout << endl;
    cout << "\033[01;31m-----用户名或密码错误-----\033[0m" << endl;
    cout << endl;
  }
  ifs.close();
  return res&&alive;
...
void User::register_account(User &user) {
  ...
  if(res){
    ...
    cout << "\033[01;32m****** 创建成功！请补充信息 ******\033[0m" << endl;
    cout << "请输入你的联系方式：";
    cin >> user.tel;
    cout << "请输入你的地址：";
    cin >> user.address;
    user.money = "0.0";
    user.is_alive = true;
    cout << "\033[01;32m****** 信息补充成功！即将返回主菜单... ******\033[0m" << endl;
    ...
    cout << "\033[01;31m****** 用户名重复，创建失败！即将返回主菜单... ******\033[0m" << endl;
  }
}